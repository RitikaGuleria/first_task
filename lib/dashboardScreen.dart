      ...
      body:
            ListView.builder(itemBuilder: (BuildContext context,int index){
              return Padding(
                ...
                child: Card(elevation: 6,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(22)),
                  child: ListTile(
                    leading: ClipRRect(
                      borderRadius: BorderRadius.circular(80),
                      child: Image.network(jsonList[index]['avatar'],fit:BoxFit.fill,height: 60,width: 60,),
                    ),
